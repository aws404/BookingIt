    ...
    public List<RecipeCategoryOptions> getCategories() {
        return List.of(
                RecipeBookAdder.builder("COOKING")
                        .addSearch()
                        .addGroup("FOOD", recipe -> recipe instanceof CookingRecipe cookingRecipe && cookingRecipe.getOutput().getItem().getGroup() == ItemGroup.FOOD, "minecraft:apple")
                        .addGroup("EVERYTHING_ELSE", recipe -> recipe instanceof CookingRecipe cookingRecipe && cookingRecipe.getOutput().getItem().getGroup() != ItemGroup.FOOD, "minecraft:dirt", "minecraft:sand")
                        .build(),

...
public class OneToOneCraftingScreen extends HandledScreen<OneToOneCraftingScreenHandler> implements RecipeBookProvider {
    ...
    public OneToOneCraftingScreen(OneToOneCraftingScreenHandler handler, PlayerInventory inventory, Text title) {
